...
//  ScrollMemoApp
//
//  Created by 植田圭祐 on 2019/11/21.
//  Copyright © 2019 Keisuke Ueda. All rights reserved.
//

import UIKit
    
class DictionaryView: UIViewController, UITabBarDelegate, UITextViewDelegate, UITableViewDataSource, UITableViewDelegate {
